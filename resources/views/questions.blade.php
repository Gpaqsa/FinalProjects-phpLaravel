                            ...
                            @foreach($questions as $qu)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="text-danger"  data-toggle="tooltip" data-target="#Modal_delete{{$qu->id}}">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
...
<!-- Modal-delete -->
                                <div class="modal fade" id="Modal_delete{{$qu->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <form method="post" action="/delete">
                                                ...
                                                <div class="modal-body">
                                                    <input style="visibility: hidden;" name="id" value="{{$qu->id}}"/>
                                                    <h3>ნამდვილად გინდა წაიშალოს ეს კითხვა ?</h3> 
