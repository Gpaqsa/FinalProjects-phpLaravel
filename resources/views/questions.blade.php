                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        @foreach ($questions as $qu)
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-warning" data-toggle="modal"
                                        data-target="#Modal_update{{ $qu->id }}">Update</a>
                                    <a href="#" class="text-danger" data-toggle="modal"
                                        data-target="#Modal_delete{{ $qu->id }}">Delete</a>
                                </td>
                            </tr>

                            <!-- Modal-Update -->
                            <div class="modal fade" id="Modal_update{{ $qu->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        <form method="post" action="/update">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <h5 class="newQuestionlabel" style="margin: 0px">Question: </h5>
                                                </div>
                                                <input style="visibility: hidden" name="id"
                                                    value="{{ $qu->id }}" />
                                                <div class="row">
                                                    <input type="text" name="question" value="{{ $qu->question }}"
                                                        style="width: 100%-20%">
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6"><input type="text"
                                                            value="{{ $qu->a }}"name="opta"></div>
                                                    <div class="col-md-6"><input type="text"
                                                            value="{{ $qu->b }}" name="optb"></div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6"><input type="text"
                                                            value="{{ $qu->c }}" name="optc"></div>
                                                    <div class="col-md-6"><input type="text"
                                                            value="{{ $qu->d }}" name="optd"></div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col md-3">
                                                        ...
                                                        <select name="answer" class="form-control">
                                                            <option value="{{ $qu->answer }}">{{ $qu->answer }}
                                                            </option>
                            ...
                            <!-- Modal-delete -->
                            <div class="modal fade" id="Modal_delete{{ $qu->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-content">
                                        <form method="post" action="/delete">
                                            ...
                                            <div class="modal-body">
                                                <input style="visibility: hidden" name="id"
                                                    value="{{ $qu->id }}" />
                                                <h5>ნამდვილად გინდა წაიშალოს ეს კითხვა ?</h5>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="post" action="/add">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <label class="newQuestionlabel" style="margin: 0px">Question: </label>
