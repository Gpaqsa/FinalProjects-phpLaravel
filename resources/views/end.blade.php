...
<body>
    ...
    <div class="container-fluid  endBack" style="margin-top: 50px; margin-left: 20px">
        <div class="row">
            <div class="4"></div>
            <div class="col-md-4">
 ...
 <div class="quizTimeImg">
            {{-- <img src="../Public/images/QuizTime.png" alt="quizTime" style="width: 100%; height:auto;"/> --}}
        </div>
